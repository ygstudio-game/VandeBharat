...
## Corpus Check
- 82 files · ~244,648 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 295 nodes · 387 edges · 22 communities (15 shown, 7 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `776cb672`
...
Cohesion: 0.08
Nodes (23): axios, CAM_TYPES, config, fs, path, { pipeline }, PIPELINE_STAGES, prisma (+15 more)
...
Cohesion: 0.14
Nodes (13): BaseModel, _all_cameras_done(), ExtractRequest, get_conn(), Frame Extractor Service — port 5003 Receives video path → OpenCV extracts every, True when every session_camera for this session has frame_count > 0., run_extraction(), OcrRequest (+5 more)
...
Cohesion: 0.24
Nodes (12): C, http, killAll(), launch(), log(), main(), path, pollHealth() (+4 more)
...
## Knowledge Gaps
- **94 isolated node(s):** `YOLO Model Files`, `name`, `private`, `start`, `setup` (+89 more)
...
- **What connects `YOLO Model Files`, `name`, `private` to the rest of the system?**
